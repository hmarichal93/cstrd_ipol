...
def TreeRingDetection(im_in, cy, cx, sigma, th_low, th_high, height, width, alpha, nr, mc, debug,
    ...
    # Line 1 Preprocessing image. Image is  resized, converted to gray scale and equalized
    ...
    # Line 5 Connect chains. Algorithm  in the paper. Im_pre is used for debug purposes
