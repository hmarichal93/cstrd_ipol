...
class devernayEdgeDetector:
    def __init__(self, nombre,img,centro,save_path, sigma=1, kernel_size=21, weak_pixel=75, strong_pixel=255, lowthreshold=5, highthreshold=15, debug=False):
        ...
        self.outputtxt = f"{str(self.root_path)}/output_{nombre}.txt"
        self.image_path = f"{str(self.root_path)}/test_{nombre}.pgm"
        self.gx_path = f"{str(self.root_path)}/gx_{nombre}.txt"
        self.gy_path = f"{str(self.root_path)}/gy_{nombre}.txt"
        self.mod_path = f"{str(self.root_path)}/mod_{nombre}.txt"
        self.non_max_path = f"{str(self.root_path)}/nonMax_{nombre}.txt"
